...
class F8Button extends React.Component {
    ...
    render() {
        ...
        if (this.props.type === 'primary') {
            var backgroundColor = this.props.backgroundColor ? this.props.backgroundColor : '#eebb09';
            var colors = [backgroundColor, backgroundColor];
            if (this.props.disabled === true) {
                colors = ['#ccc', '#ccc'];
            }
            var containStyle = [styles.button, styles.primaryButton, this.props.contentStyle];
            var childStyle = [styles.caption, styles.primaryCaption, this.props.textStyle];
            content = (
                <LinearGradient
                    colors={colors}
                    style={containStyle}>
