...
var EmptyPostsList = require('./EmptyPostsList');
var FilterPostsHeader = require('./FilterPostsHeader');
var FilterPosts = require('./filterPosts');
...
const data = createSelector(
    ...
    (store) => store.filter,
    (sessions, filter) => FilterPosts.byTopics(sessions, filter),
);
...
class PostsDailyView extends React.Component {
    props: Props;
...
module.exports = connect(select, actions)(PostsDailyView);
